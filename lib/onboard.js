...
function configureOpenClaw(port) {
  ...
  config.models.providers['model-foundry'] = buildOpenClawProviderConfig(port)

  if (!config.agents) config.agents = {}
  if (!config.agents.defaults) config.agents.defaults = {}
  if (!config.agents.defaults.model) config.agents.defaults.model = {}
  config.agents.defaults.model.primary = 'model-foundry/auto-fastest'

  if (!config.agents.defaults.models) config.agents.defaults.models = {}
  if (!config.agents.defaults.models['model-foundry/auto-fastest']) {
    config.agents.defaults.models['model-foundry/auto-fastest'] = {}
  }
...
function printIntegrationSnippets(port) {
  ...
  const openclawSnippet = [
    ...
    '  "agents": {',
    '    "defaults": {',
    '      "model": { "primary": "model-foundry/auto-fastest" },',
    '      "models": { "model-foundry/auto-fastest": {} }',
    '    }',
    '  }',
    '}',
  ].join('\n')
